...
var positionMessage = 0;
var pInit=0;
var messageProcess = true;
var colorStatus = "#ffffff";
var optionMessage;

function addPMessage(){
    optionMessage = comboboxOptions.options[comboboxOptions.selectedIndex].value;
    pInit = optionMessage;
    for (let i = 0; i < n1; i++){
...
function drawInit() {
    ...
    for (let i = 0; i < n1; i++) {
        ...
        var newNode = { x: x1, y: y1, id: i, angle, messageProcess: pInit };
...
var positionMessage2 = 0;
var pInit2 = 0;
var messageProcess2 = true;
var optionMessage2;

function addPMessage2(){
    optionMessage2 = comboboxOptions2.options[comboboxOptions2.selectedIndex].value;
    pInit2 = optionMessage2;
    for (let i = 0; i < n1; i++){
...
function drawInit2() {
    ...
    for (let i = 0; i < n1; i++) {
        ...
        var newNode = { x: x1, y: y1, id: i, angle, messageProcess2: pInit2 };
...
function drawInit3() {
    ...
    for (let i = 0; i < n1; i++) {
        ...
        var newNode = { x: x1, y: y1, id: i, angle, messageProcess2: pInit3 };
        arrayNodes2.push(newNode);
